...
export const EXISTING_USER_LOGIN = "EXISTING_USER_LOGIN";
export const EXISTING_USER_LOGIN_SUCCESS = "EXISTING_USER_LOGIN_SUCCESS";
export const EXISTING_USER_LOGIN_FAILED = "EXISTING_USER_LOGIN_FAILED";

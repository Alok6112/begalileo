...
const LongMultiplicationSelectChoiceType = ({data, submitResponse, screenType, isResponse, handleStudentAnswerCorrect}) => {
  ...
  return (
      <View>
        <View style={styles.outterSection}>
          <View style={{width: '80%'}}>
            <View style={{marginTop: 10,marginLeft:10, display:"flex",alignItems:"flex-start"}}>
                        ...
                        item.map((val)=>{
                            if(val.isMissed == 'false'){
                                return  <View style={[styles.row,{display:"flex",justifyContent:"center",alignItems:"center",margin:5}]}>
                                 ...
                                 return <View style={[styles.row,{display:"flex",justifyContent:"center",alignItems:"center",margin:5}]}>
                                   <View style={{height:30,width:50,borderWidth:1,borderRadius:5}}>
                                    </View>
...
export default LongMultiplicationSelectChoiceType;
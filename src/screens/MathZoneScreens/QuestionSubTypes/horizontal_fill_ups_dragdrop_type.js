...
import {commonDragDropTypeStudentResponse} from '../QuestionAsserts/commonFileForStudentResponses'
...
const HorizontalFillUpsDragDropType = ({data, submitResponse, screenType, isResponse, handleStudentAnswerCorrect}) => {
                ...
                rows.map((row,index) => {
                  return (
                    <View style={[styles.row,{flexWrap:"wrap"}]}>
                      {question.questionContent.map((val,i) => {
                        if(parseInt(row-1) == parseInt(val.row) ){
                            ...
                            return (
                                ...
                                <View style={{borderWidth:1,height:40,minWidth:70,borderRadius:30,margin:3}}>
                              ...
                              >
                               ...
                               {console.log("droppedValues[dropped_index]?.value",droppedValues[dropped_index]?.value)}
                               <QuestionPartBuilder data= {droppedValues[dropped_index]?.value} isWhite={true}/>
                                  {/* <Text style={{ color: "#fff", fontWeight: "bold" }}>
                                  {convertHTML(droppedValues[dropped_index]?.value)}
                                </Text> */}
                              </DraxView>
                  ...
                  {draggableValues.map((item, i) => (
                    <View
                     ...
                     
                     {
                      ...
                      { item.value != "" &&<QuestionPartBuilder data= {convertHTML(item.value)} isWhite={true}/>}
                        </DraxView>
                     }
...
export default HorizontalFillUpsDragDropType;
...
// const windowHeight = Dimensions.get('window').height;
// const HorizontalFillUpsDragDropType = ({data, submitResponse, screenType, isResponse}) => {

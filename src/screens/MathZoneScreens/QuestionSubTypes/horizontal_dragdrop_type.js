...
const HorizontalDragDropType = ({data, submitResponse, screenType, isResponse,handleStudentAnswerCorrect}) => {
                          ...
                          return (
                              ...
                              
                            {
                              ...
                              style={[
                                ...
                                {
                                  val.studentAnswer.includes("mq-selectable") ?  <QuestionPartBuilder data= {val.studentAnswer} isWhite={true}/> :
...
export default HorizontalDragDropType;
...
// import HtmlViwer from '../QuestionAsserts/HtmlRender';
// import ModalTester from '../QuestionAsserts/outputResponseModal';
// import {commonDragDropTypeStudentResponse2D} from '../QuestionAsserts/commonFileForStudentResponses'
// import {MATH_ZONE_QUESTION, MATH_ZONE_LIVE_CLASS_QUESTION , MATH_ZONE_FLAGGED_QUESTION, MATH_ZONE_HOME_WORK_QUESTION} from '../../../components/helpers/Constants'
// import SolutionComponent from '../QuestionAsserts/outputResponseComponent';
// import MathQuillHtmlRender from "../QuestionAsserts/MathQuillHtmlRender";

// const windowHeight = Dimensions.get('window').height;
// const HorizontalDragDropType = ({data, submitResponse, screenType, isResponse}) => {

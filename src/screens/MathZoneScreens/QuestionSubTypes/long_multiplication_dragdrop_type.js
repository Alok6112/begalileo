...
const LongMultiplicationDropType = ({data, submitResponse, screenType, isResponse, handleStudentAnswerCorrect}) => {
...
export default LongMultiplicationDropType;
...
// const windowHeight = Dimensions.get('window').height;
// const LongMultiplicationDropType = ({data, submitResponse, screenType, isResponse}) => {

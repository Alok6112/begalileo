...
import { Button, Pressable, Text, View, StyleSheet, ScrollView, Image } from 'react-native';
...
function ModalTesterGeneric({ isCorrect, solution, isMathquill, isOldType, type }) {
...
`;
    ...
    return <View style={{ width: "100%" }}>
        {/* {openAnimation == true && <View
            ...
            {
                !studentAnswerCorrect && openAnimation && <LottieView
                    style={{ height: 100, position: "absolute", bottom: "0%", left: '30%' }}
                ...
                >
                    ...
                    <ScrollView>
                        <View>
                            ...
                            <View>
                                {type == 'multiselect' && isOldType ? <View>
                                    {
                                                ...
                                                }
                                                {
                                                    item.solution_image != "" ?
                                                        <View style={{ minWidth: 300, height: 200, margin: 10 }}>
                                                            <Image source={{ uri: item.solution_image }}
                                                                style={{ minWidth: 400, height: 200, margin: 10 }} />
                                                        </View> : <></>
                                                }
                                            </>
                                        })
                                    ...
                                    isOldType ? <View>
                                        ...
                                        }
                                        {
                                            solution.solution_image != "" ?
                                                <View style={{ minWidth: 300, height: 200, margin: 10 }}>
                                                    <Image source={{ uri: solution.solution_image }} resizeMode={'contain'}
                                                        style={{ aspectRatio: 2, height: "100%", width: "100%" }} />
                                                </View> : <></>
                                        }

                                    </View> : isMathquill == true ? (
...
export default ModalTesterGeneric;

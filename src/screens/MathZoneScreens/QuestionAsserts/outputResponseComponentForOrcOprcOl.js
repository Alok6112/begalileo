...
function SolutionComponentForOrcOprcOl({ isCorrect, data, type }) {
            ...
            <View style={{ width: '100%', display: "flex", justifyContent: "center" }}>
                <View style={{ position: "relative", left: "74.5%" }}>
                    <Pressable onPress={toggleModal}>
                        <View style={{ height: 30, width: 95, borderWidth: 1, display: "flex", justifyContent: "center", alignItems: "center" }}>
                            {isModalVisible ? <Text>Hide Details</Text> : <Text>View Details</Text>}
                        </View>
                    </Pressable>
                </View>
                <View style={{ borderWidth: 1, minHeight: 100, width: '90%' }}>
                    {
                        isCorrect ? <View style={{ height: 100, width: '100%', display: "flex", justifyContent: "center", backgroundColor: "#CCEEA5" }}>
                            <Text style={{ marginLeft: 5 }}>
                                Well Done
                            </Text>
                        </View> :
                            <View style={{ height: 100, width: '100%', display: "flex", justifyContent: "center", backgroundColor: "#fae0e0" }}>
                                <Text style={{ marginLeft: 5 }}>
                                    Incorrect
                                </Text>
                            </View>
...
export default SolutionComponentForOrcOprcOl;

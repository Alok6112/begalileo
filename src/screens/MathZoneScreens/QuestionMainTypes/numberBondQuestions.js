...
import NumberBondKeyingType from '../QuestionSubTypes/number_bond_keying_type';
import NumberBondSelectChoiceType from '../QuestionSubTypes/number_bond_selectchoice_type';
import Canvas from 'react-native-canvas';

const NumberBondQuestions = ({data, submitResponse, screenType, isResponse, handleStudentAnswerCorrect}) => {
...
export default NumberBondQuestions;

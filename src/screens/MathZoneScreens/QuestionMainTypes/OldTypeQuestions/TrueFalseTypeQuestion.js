...
import {Text, View, StyleSheet, Pressable, Dimensions, Image, ScrollView} from 'react-native';
...
const TrueFalseQuestions = ({data, submitResponse, screenType, isResponse, handleStudentAnswerCorrect}) => {

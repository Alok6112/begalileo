...
import {MATH_ZONE_HOME_WORK_QUESTION as ScreenType} from '../../../../components/helpers/Constants';
...
const HomeWorkMathZoneHome = forwardRef((props, ref) => {
  ...
  useEffect(() => {
    ...
    console.log('data of homework', data);
  ...
  useImperativeHandle(ref, () => ({
    ...
    onRemoteLineUpdate(whiteBoardLines) {
      console.log(whiteBoardLines.length, 'length');
...
export default HomeWorkMathZoneHome;

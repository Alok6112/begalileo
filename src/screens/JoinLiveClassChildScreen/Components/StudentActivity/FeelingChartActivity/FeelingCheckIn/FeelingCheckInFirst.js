...
import FeelingCheckInLast from "./FeelingCheckInLast";

export default function FeelingCheckInFirst({
  isCheckInActivity,
  apiData,
  liveClassId,
  studentId,
  ...
  return (
    <>
      ...
      checkInResponse[0]?.gif_image != undefined ? (
        ...
        <View>
          {!showLastScreen ? (
            <>
              ...
              >
                <Text style={[CommonStyles.text_14_bold, { color: "#233584" }]}>
                  Pick a feeling from the given feelings on your screen and drag
                  it in the empty box
                </Text>
              </View>
            ...
            <View>
              <FeelingCheckInLast selectedGif={selectedGif} />
            </View>
          )}
        </View>
      )}

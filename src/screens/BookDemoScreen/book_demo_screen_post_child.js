...
class BookDemoScreenPostChild extends Component {
  constructor(props) {
    super(props);
  ...
  componentDidMount() {
    ...
    var kidDetail = this.props.currentSelectedKid;
    let todayDate = new Date();
    var parentDetails = this.props.dashboardResponse.parent_details[0];
    this.setState(
      {
        dobDate: todayDate,
        selectedDateText: moment(todayDate).format('DD-MMM-YYYY'),
        selectedDate: moment(todayDate).format('YYYY-MM-DD'),
        selectedGrade: kidDetail.grade,
        mChildName: kidDetail.name,
        mUserMobileNumber: parentDetails.mobile,
        mUserEmail: parentDetails.email,
        mUserId: parentDetails.id,
      },
      () => {
  ...
  onBookDemo = () => {
    console.log('Current Kid', this.props.currentSelectedKid);
    ...
    if (this.state.mChildName == '') {
      console.log('child NAMe Missing');
      this.setState({
        childNameError: true,
      });
      isValid = false;
  ...
  render() {
    ...
    const parentDetails = this.props.dashboardResponse.parent_details[0];

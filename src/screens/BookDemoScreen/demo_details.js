...
class DemoDetails extends Component {
  ...
  componentDidMount() {
    ...
    var demoDetails = getParamNavigationV5(this.props, 'demoDetail', null);
    if (demoDetails != null) {
      this.setState({
  ...
  componentDidUpdate(prevProps) {
    console.log(
      prevProps.cancelSlotStatus + '---' + this.props.cancelSlotStatus,
    );
  ...
  cancelDemo = () => {
    ...
    if (this.state.isDemoConfirmed) {
      this.props.cancelConfirmedDemo(
        this.props.dashboardResponse.parent_id,
        this.state.demoDetail.demo_class_id,
      );
    } else
      this.props.cancelPreferredSlot(
        this.state.studentId,
        this.state.demoDetail.preferred_slot_id,
      );
  };
  ...
  render() {
    const {isCancelConfirmationDemoVisible, isDemoConfirmed, demoDetail} =
      this.state;
    ...
    return (
      <View style={styles.mainContainer}>
        ...
        <ScrollView showsVerticalScrollIndicator={false} style={{flex: 1}}>
          <View>
            <View
              style={{marginTop: normalize(20), marginStart: normalize(12)}}>
              <Text
                style={[
              ...
              <View
                ...
                <View>
                  <Text
                    ...
                    Are you sure you want to cancel the demo?
                  </Text>
                  <View
                    style={{
                  ...
                  <View
                    ...
                    <TouchableOpacity
                      ...
                      onPress={this.cancleConfiramtiondemo}>
                      <Text
                        style={{
                          fontFamily: Constants.Montserrat_Regular,
                          textAlign: 'center',
              ...
              <View>
                <View style={{alignItems: 'center'}}>
                  <Image
                    ...
                    source={IC_DEMO_CONFIRM_SUCCESS}
                  />
                </View>
                <View
                  style={{
                  ...
                  <View style={{flexDirection: 'column'}}>
                    ...
                    <Text
                      ...
                      {this.state.demoDetail.date}
                      {'\n'}
                      {this.state.demoDetail.time}
                    </Text>
                  </View>
                  <View
                    style={{
            ...
            <View
              style={{marginTop: normalize(32), marginStart: normalize(20)}}>
              <Text style={CommonStyles.text_12_bold}>Things to note</Text>
              <Text style={[CommonStyles.textBody_1, styles.thingsToNoteText]}>
                Please join the class at least a few minutes before the
                schdeuled time.
              </Text>
              <Text style={[CommonStyles.textBody_1, styles.thingsToNoteText]}>
                Our Tech support team will call you for a check before the
                class.
              </Text>
